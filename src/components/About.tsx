        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              At <strong>Sales Cowboy Marketing</strong>, we don't follow the herd. We blaze trails with bold, data-driven strategies that deliver real results for Nigerian businesses. From building stunning websites to dominating search rankings and running high-ROI ad campaigns, we bring the grit and expertise your brand needs to win in the Nigerian market.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
              We're a team of fearless marketers, developers, and strategists based in Nigeria, combining Western tenacity with cutting-edge tech. We understand the Nigerian market and know what works here. No fluff. No gimmicks. Just strategies that work for Nigerian businesses across Lagos, Abuja, and beyond.
            </p>
            <div className="pt-4 border-t border-border">
              <p className="text-sm text-muted-foreground italic">
                <strong>Sales Cowboy Marketing:</strong> Marketing that rides hard and wins big.
              </p>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <Image 
              ...
              alt="Sales Cowboy Marketing team collaborating with Nigerian real estate agents"
